...
<div class="full-box page-header">
  ...
  <p class="text-justify">
    ...
    laudantium necessitatibus eius iure adipisci modi distinctio. Earum
    repellat iste et aut, ullam, animi similique sed soluta tempore cum quis
    corporis!
  </p>
</div>
...
<div class="container-fluid">
  ...
  $data_item = $ins_item->selectItemController("Unique", $page[1]);

  if ($data_item->rowCount() == 1) {
    $content = $data_item->fetch();
  ?>
    <form class="form-neon FromAjax" action="<?php echo APP_SERVER; ?>ajax/itemAjax.php" method="POST" data-form="update" autocomplete="off">
          ...
          <div class="row">
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" pattern="[a-zA-Z0-9\-]{1,45}" class="form-control" name="item_codigo_up"
                  id="item_codigo" maxlength="45" value="<?php echo $content['item_codigo']; ?>" required="" />
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" name="item_nombre_up"
                  id="item_nombre" maxlength="140" value="<?php echo $content['item_nombre']; ?>" required="" />
              </div>
            </div>
            ...
            <div class="col-12 col-md-4">
              <div class="form-group">
                ...
                <input type="num" pattern="[0-9]{1,9}" class="form-control" name="item_stock_up" id="item_stock"
                  maxlength="9" value="<?php echo $content['item_stock']; ?>" required="" />
              </div>
            </div>
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <select class="form-control" name="item_estado_up" id="item_estado">
                  <option value="Habilitado" <?php if ($content['item_estado'] == "Habilitado") {
                                                echo 'selected=""';
                                              } ?>>Habilitado</option>
                  <option value="Deshabilitado" <?php if ($content['item_estado'] == "Deshabilitado") {
                                                  echo 'selected=""';
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ\(\).,#\- ]{1,190}" class="form-control"
                  name="item_detalle_up" id="item_detalle" maxlength="190" value="<?php echo $content['item_detalle']; ?>" />
              </div>
            </div>
          </div>
        </div>
