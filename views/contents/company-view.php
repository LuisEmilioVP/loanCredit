  ...
  <div class="full-box page-header">
    ...
    <p class="text-justify">
      ...
      eaque nostrum, voluptates, rerum quo. Consequuntur ut, maxime? Quibusdam
      ipsum maxime non veritatis dignissimos qui reiciendis, amet eum nihil!
      Et!
    </p>
  </div>
  ...
  $data_company = $company->selectCompanyController();

  if ($data_company->rowCount() == 0) {
  ?>
    <div class="container-fluid">
      <form class="form-neon FromAjax" action="<?php echo APP_SERVER; ?>ajax/companyAjax.php" method="post" data-form="save" autocomplete="off">
        <fieldset>
          <legend>
            <i class="far fa-building"></i> &nbsp; Información de la empresa
          </legend>
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" pattern="[0-9\(\)\+ ]{14,20}" class="form-control" name="empresa_telefono_reg"
  ...
  <?php } else if ($data_company->rowCount() == 1 && ($_SESSION['role_spm'] == 1 || $_SESSION['role_spm'] == 2)) {
    $content = $data_company->fetch();
  ?>
    <div class="container-fluid">
