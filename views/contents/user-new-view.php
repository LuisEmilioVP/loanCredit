...
<div class="container-fluid">
  <ul class="full-box list-unstyled page-nav-tabs">
    <li>
      <a class="active" href="<?php echo APP_SERVER; ?>user-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO
        USUARIO</a>
    </li>
    <li>
...
<!-- Content -->
<div class="container-fluid">
  <form class="form-neon FromAjax" action="<?php echo APP_SERVER; ?>ajax/userAjax.php" method="post" data-form="save" autocomplete="off">
    <fieldset>
      <legend>
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,35}" class="form-control" name="usuario_nombre_reg"
                id="usuario_nombre" maxlength="35" required="" />
            </div>
          </div>
          <div class="col-12 col-md-4">
            <div class="form-group">
        ...
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <input type="text" pattern="[a-zA-Z0-9]{3,35}" class="form-control" name="usuario_usuario_reg"
                id="usuario_usuario" maxlength="35" required="" />
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <input type="email"
                ...
                class="form-control" name="usuario_email_reg" id="usuario_email" maxlength="70" />
            </div>
          </div>
          <div class="col-12 col-md-6">
            <div class="form-group">
