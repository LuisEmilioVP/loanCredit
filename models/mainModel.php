...
class mainModel
{
  ...
  protected static function pagination($page, $numPages, $url, $buttons)
  {
    ...
    if ($page == $numPages) {
      ...
      $table .= '
				...
				<li class="page-item"><a class="page-link" href="' . $url . $numPages . '/"><i class="fas fa-angle-double-right"></i></a></li>
				';
    }
